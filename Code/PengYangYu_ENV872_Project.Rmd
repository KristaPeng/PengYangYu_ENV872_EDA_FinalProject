...
# Load datasets
EPAair_O3 <- read.csv("E:/EDA-project/PengYangYu_ENV872_EDA_FinalProject/Data/Processed/o3_cleaned.csv", 
                      stringsAsFactors = TRUE, row.names = 1) 
EPAair_O3$Date <- ymd(EPAair_O3$Date)
counties_NC_sf<- st_read('E:/EDA-project/PengYangYu_ENV872_EDA_FinalProject/Data/Spatial/cb_2018_us_county_20m.shp') %>%
  filter(STATEFP == 37)
