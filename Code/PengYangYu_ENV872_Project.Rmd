...
# Set working directory
setwd('E:/EDA-project/PengYangYu_ENV872_EDA_FinalProject/Data')

# Set your ggplot theme
mytheme <- theme_bw(base_size = 12) + theme(legend.position = "right")
theme_set(mytheme)
# Read in dataset
o3_cleaned <-read.csv("E:/EDA-project/PengYangYu_ENV872_EDA_FinalProject/Data/Processed/o3_cleaned.csv", stringsAsFactors = TRUE)
...
### 3.1.1 Obtain basic summaries of the data
```{r,, echo=FALSE}
dim(o3_cleaned1)
summary(o3_cleaned1)
```
...
###  3.1.2 The number of ozone concentrations collected conducted by year and sites
...
### 3.1.3 Linear relation between Ozone concentration and daily AQI
...
### 3.1.4 Boxplot:Relationship between O3 Concentration and month (2022)
...
###  Relationship 03 Concentration and Year

### 3.1.5 Violin plot: Relationship between O3 Concentration and month (2022)
...
### 3.1.6 Distribution of concentration at three different sites by years
...
```{r Q2 ANOVA, echo=FALSE, fig.cap="Fig.8 Normal Q-Q Plot for concentrations and sites", fig.align='center'}
# Test for normality
nor = 0
...
```{r Q3, echo=FALSE, fig.cap="Fig.9 Frequency polygons of ozone in 2021 and 2022", fig.align='center'}
...
```{r Q3 T-test, echo=FALSE, fig.cap="Fig.10 Normal Q-Q Plot for concentrations in 2021 & 2022", fig.align='center'}
# Test for normality
...
```{r Q4 Spatial analysis 1, message=FALSE, echo=FALSE, fig.cap="Fig.11 mapview of Ozone concentration in NC", fig.align='center'}
...
```{r Q4 Spatial analysis 2, message=FALSE, echo=FALSE, fig.cap="Fig.12 Ozone concentration in NC", fig.align='center'}
# Map the sites by ggplot
 ggplot() +
   ...
   labs(scale_color_continuous(name="Ozone concentration")
```
...
```{r Q5, echo=FALSE, fig.cap="Fig.13 Ozone concentrations at Rockwell from 2016 to 2022", fig.align='center'}
...
```{r Q5 Time series analysis, echo=FALSE, fig.cap="Fig.14 Seasonal Mann-Kendall test", fig.align='center'}
# Interpolate dates
